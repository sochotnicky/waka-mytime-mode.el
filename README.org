...
`waka-mytime-mode` is a non-official wakatime mode for Emacs. It's a
...
makes API calls using [[https://tkf.github.io/emacs-request/][request.el]]. It is only tested with [[https://github.com/muety/wakapi][wakapi]] and might or
might not work with [[https://wakatime.com][wakatime.com]].
